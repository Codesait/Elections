...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder.setMessage("Please always make sure your location is on...")
                .setTitle("NOTICE!")
...
//                Bundle bundle1 = new Bundle();
                    ...
                    Intent camera = new Intent(Home.this, Camera.class);
                    camera.putExtra("lat", latitude);
                    camera.putExtra("long", longitude);
                    camera.putExtra("firstname", fName);
                    camera.putExtra("lastname", lName);
...
// Resuming the periodic location updates
    ...
    private void displayLocation() {
        if (ActivityCompat.checkSelfPermission(this,
            ...
            MDToast.makeText(Home.this,"Location permission is not granted,please enable location",
...
//            AlertDialog.Builder builder = new AlertDialog.Builder(Home.this);
//            builder.setMessage("This feature is available on our new version")
//                    .setTitle("Oops!")
